...
- **空岛战争开箱**：出生岛 3 箱（**每箱保底两件铁质装备**——剑/斧/护甲随机，3 箱铁装几乎必齐；外加**两小叠搭桥方块**分散放置，不再一整大组）；铁质装备刷新进一步增加（含铲子/锄头/镐等**铁质杂项**）；**附魔削弱**——锋利/保护/力量**最高 II 级**（55% I / 45% II），**击退最高 1 级**；新增 **铁砧 + 经验瓶**（可合成/附魔）、**钓鱼竿**（命中把人击退）、**追踪罗盘**（指向最近敌人）、**雪球 ×16**、**低概率粘液球**（击退 III 近战武器）；金苹果与蜘蛛网刷新量上调；中间主岛箱子更富（钻石装为主，还会出**重锤**、更多 TNT/岩浆桶等）；**药水**含速度 I/II、跳跃 I/II、力量 I、生命恢复 I/II、瞬间治疗 I/II（饮用或喷溅）；中间岛每箱约 3% 概率出**极稀有物品**（鞘翅+3 烟花火箭、附魔金苹果、**不死图腾**各约 1%）；**秒人斧只刷新在玩家岛**（出生箱约 1%），玩家岛也可能出**不死图腾**（约 1%）。
