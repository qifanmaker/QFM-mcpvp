...
- **空岛战争 (Beta)**：每人随机一座出生空岛（3 箱）+ 地图中央主岛（箱子更富），**无套件、生存模式开箱搜装备**；武器/护甲随机附魔（低等级概率高）；**极低概率**开箱出 **鞘翅+3 烟花火箭、妙人斧（锋利 666 金斧·耐久 1）、附魔金苹果**；凑齐 4 人开赛（最少 2 人、最多 8 人），**3 分钟后缩圈**逼团，最后幸存者获胜
