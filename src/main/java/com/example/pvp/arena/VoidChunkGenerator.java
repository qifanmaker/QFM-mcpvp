...
/**
 * 纯虚空区块生成器：不生成任何方块、不刷怪、无结构。
 * 竞技场平台由 {@link ArenaWorldManager} 手动放置方块搭建。
...
public class VoidChunkGenerator extends ChunkGenerator {
    ...
    public static final MultiNoiseUtil.MultiNoiseSampler EMPTY_SAMPLER = new MultiNoiseUtil.MultiNoiseSampler(
